...
x_var = st.selectbox(
    label = "选择横坐标的属性",
    options = ['bill_length_mm', 'bill_depth_mm', 'flipper_length_mm', 'bode_mass_g']
)
...
fig, ax = plt.subplots()
ax = sns.scatterplot(data=df, x=x_var, y=y_var, hue='species', markers=markers, style='species')
plt.xlabel(x_var)
plt.ylabel(y_var)
